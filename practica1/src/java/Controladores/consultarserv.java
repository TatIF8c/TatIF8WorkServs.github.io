 ...
 * @author santi
 */
@WebServlet(name = "consultarserv", urlPatterns = {"/consultarserv"})
public class consultarserv extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        for (Producto prod : Arrays.listprodu) {
            if(prod.getProducto().toUpperCase().equals(bus)){
               out.println(" <div class=\"contenedor\"><h1> Información del prodcuto </h1> <ul> <li><strong>Nombre:</strong>"+prod.getProducto() +"</li> <li><strong>Precio:</strong>"+prod.getPresio()+"</li> <li><strong>Existencias:</strong>"+prod.getExistencias()+"</li> ");
            }
            else{
